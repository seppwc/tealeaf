...
export const Elevation: TealValueObject = {
  shadow: {
    ...
    "2":
      "0px 2px 4px -1px rgba(50, 50, 93, 0.1), 0px 2px 3px -1px rgba(0, 0, 0, 0.18)",
    "3":
      "0px 4px 7px -2px rgba(50, 50, 93, 0.18),0px 4px 7px -2px rgba(0, 0, 0, 0.22)",
    "4":
      "0px 6px 10px -2px rgba(0, 0, 0, 0.1),0px 6px 10px -2px rgba(0, 0, 0, 0.22)",
    "5":
      "0px 8px 12px -2px rgba(50, 50, 93, 0.18),0px 6px 12px -5px rgba(0, 0, 0, 0.22)",
    "6":
      "0px 13px 27px -5px rgba(50, 50, 93, 0.22),0px 8px 16px -8px rgba(0, 0, 0, 0.3)",
    "7":
      "0px 25px 50px -12px rgba(0, 0, 0, 0.22), 0px 10px 24px -8px rgba(0, 0, 0, 0.22)",
    "8": "0px 20px 40px -5px rgba(0, 0, 0, 0.22)",
  },
  insetshadow: {
